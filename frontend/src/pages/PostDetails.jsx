...
const PostDetails = () => {
  ...
  const handleDeletePost =async() =>{
    try {
      ...
      console.log(res.data);
      navigate("/")//after action navigate to this route
    } catch (err) {
      console.log(err);
    }
  }
  ...
  return (
    <div>
        <Navbar/>
        {loader? <div className="h-[80vh] flex justify-centre items-centre w-full"> <Loader/></div>: <div className="px-8 md:px-[200px] mt-8">
